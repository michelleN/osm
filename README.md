...
| TrafficSplit | trafficsplits.split.smi-spec.io | [4](https://github.com/servicemeshinterface/smi-spec/blob/v0.6.0/apis/traffic-split/v1alpha4/traffic-split.md) | |
